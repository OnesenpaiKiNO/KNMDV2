...
getContentType, downloadContentFromMessage } = require('@adiwajshing/baileys');
 ...
 module.exports = async (
   ...
   let fkontak = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: '6289602518223-1604595598@g.us' } : {})}, message: { "contactMessage":{"displayName": `Thunder-Multi`,"vcard":`BEGIN:VCARD\nVERSION:3.0\nN:2;kino;;;\nFN:kino\nitem1.TEL;waid=6287708357324:6287708357324\nitem1.X-ABLabel:Mobile\nEND:VCARD` }}}               
   ...
   let button = [{
     index: 1, 
      urlButton: {
       ...
       url: 'https://github.com/OnesenpaiKiNO'
       } 
     },     
     {
     index: 2, 
...
.then((a) => {
  ...
  case 'p':
   sock.sendMessage(
     ...
     { 
      image: { 
       url: "https://telegra.ph/file/e77c78b4b8c31006bdfcf.jpg" 
       } 
      }, 
     { quoted: m }
    )
